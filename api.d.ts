 ...
 */
export type RpcResponse<C extends Command> = { success: false, error: string } | { success: true } & Returns<C>

/**
 * Internal handler for command `C`
 */
export type RpcHandler<C extends Command> = (request: RpcRequest<C>) => Promise<RpcResponse<C>>
